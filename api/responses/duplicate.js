 ...
 *     // -or-
 *     return res.duplicate(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function duplicate(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.duplicate()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.duplicate()` called with an Error:', optionalData);
