 ...
 *     // -or-
 *     return res.notAuthenticated(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function notAuthenticated(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.notAuthenticated()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.notAuthenticated()` called with an Error:', optionalData);
